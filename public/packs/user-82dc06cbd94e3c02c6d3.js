...
var User = function (_Component) {
  ...
  function User(props) {
    ...
    $.getJSON('/recherche?q=' + _this.state.term).then(function (response) {
      return _this.setState({ autoCompleteResults: response.restaurants });
    });
    return _this;
  }
  ...
  _createClass(User, [{
    ...
    value: function getAutoCompleteResults(e) {
      ...
      this.setState({
        ...
        $.getJSON('/recherche?q=' + _this2.state.term).then(function (response) {
          return _this2.setState({ autoCompleteResults: response.restaurants });
        });
      });
    }
  }, {
    ...
    value: function render() {
      ...
      var autoCompleteList = this.state.autoCompleteResults.map(function (response, index) {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'div',
          { key: index, className: 'restaurant-wrapper' },
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'h4',
            { className: 'titre-restaurant' },
            response.name
          ),
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'p',
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          ...
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { ref: function ref(input) {
              ...
              }, value: this.state.term, onChange: this.getAutoCompleteResults.bind(this), type: 'text', placeholder: 'Recherche par nom ou ville', className: 'recherche-input' })
          )
        ),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'h4',
...
document.addEventListener('DOMContentLoaded', function () {
  __WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(User, null), document.body.appendChild(document.createElement('div')));
});

/***/ })
/******/ ]);
//# sourceMappingURL=user-82dc06cbd94e3c02c6d3.js.map